# unreal-unity-poc organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`unreal-unity-poc`](https://github.com/unreal-unity-poc).

## Canonical organization links

- GitHub organization: https://github.com/unreal-unity-poc
- Public organization defaults: https://github.com/unreal-unity-poc/.github
...
`unreal-unity-poc` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
